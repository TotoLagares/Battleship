...
public class Tablero {
    ...
    public void crearBarcos(){
        ...
        switch (random) {
            ...
            case 11 -> {
                for (int i = 0; i < 5; i++) a[i][2].setTieneBarco(true);
                for (int j = 5; j < 9; j++) a[6][j].setTieneBarco(true);
                for (int j = 0; j < 3; j++) a[8][j].setTieneBarco(true);
                for (int i = 5; i < 8; i++) a[i][6].setTieneBarco(true);
                a[9][9].setTieneBarco(true);
                a[8][8].setTieneBarco(true);
            }
            ...
            case 13 -> {
                for (int i = 0; i < 5; i++) a[i][5].setTieneBarco(true);
                for (int j = 0; j < 4; j++) a[9][j].setTieneBarco(true);
                for (int j = 4; j < 7; j++) a[3][j].setTieneBarco(true);
                for (int i = 6; i < 9; i++) a[i][8].setTieneBarco(true);
                a[4][1].setTieneBarco(true);
                a[5][2].setTieneBarco(true);
            }
            ...
            case 15 -> {
                for (int j = 2; j < 7; j++) a[4][j].setTieneBarco(true);
                for (int i = 6; i < 10; i++) a[i][0].setTieneBarco(true);
                for (int j = 5; j < 8; j++) a[8][j].setTieneBarco(true);
                for (int i = 0; i < 3; i++) a[i][9 - i].setTieneBarco(true);
                a[5][5].setTieneBarco(true);
